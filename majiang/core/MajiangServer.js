...
class MajiangServer {
    ...
    doStart() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.USER_COUNT; i++) {
                let userCards = yield this.pile.getMany(this.CARD_COUNT);
            ...
            let allCards = Utils_1.flat(pile, this.shown, this.hand, this.rubbish, Utils_1.li(4, this.anGang));
    ...
    doFetch(fetcher) {
        return __awaiter(this, void 0, void 0, function* () {
            //从牌堆摸一张牌，返回胜利者的ID
            const fetched = yield this.pile.getCard();
            if (!fetched) {
                //如果牌为空，表明没牌了
                const responses = yield this.broadcast(turn => {
                    const resp = {
                        ...
                        hand: Utils_1.deepcopy(this.hand),
                        anGang: Utils_1.deepcopy(this.anGang),
                    };
                    return resp;
                });
                return -1;
        ...
        for (let receiver = 0; receiver < this.USER_COUNT; receiver++) {
            ...
            switch (response.mode) {
                ...
                case MajiangProtocol_1.ReleaseResponseMode.EAT: {
                    ...
                    Card_1.sortCards(a);
                    //吃了的牌必须是顺子
                    if (!(Card_1.C.byName(a[0]).sparseIndex + 1 == Card_1.C.byName(a[1]).sparseIndex &&
                        Card_1.C.byName(a[0]).sparseIndex + 2 == Card_1.C.byName(a[2]).sparseIndex)) {
