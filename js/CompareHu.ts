import {getCard, getCards, hu, sortCards} from "./Card";
import {randChoose, getCount, li, randInt, random, shuffle, swap} from "./Utils";
import {huByTable, shuziPai} from "./TableHu";
import {buildIndex} from "./ai/MyJudger";
 ...
 * */
const cardCount2pattern = buildIndex(shuziPai);
